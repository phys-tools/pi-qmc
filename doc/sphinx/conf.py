# -*- coding: utf-8 -*-
#
# pi-qmc documentation build configuration file, created by
...
# of the sidebar.
html_logo = "images/pi-logo64.png"
...
man_pages = [
    ('index', 'pi-qmc', u'pi-qmc Documentation',
     [u'John Shumway'], 1)
]
...
texinfo_documents = [
  ('index', 'pi-qmc', u'pi-qmc Documentation',
   u'John Shumway', 'pi-qmc', 'One line description of project.',
   'Miscellaneous'),
]
...
# -- Latex Options #
pngmath_latex_preamble = "\usepackage{amssymb,amsmath,esint}"
